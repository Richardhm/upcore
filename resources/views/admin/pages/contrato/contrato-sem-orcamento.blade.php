...
<div class="card card-primary card-tabs">
    <div class="card-header p-0 pt-1">
        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link {{(request()->get('ca') == 'pf' || empty(request()->get('ca')) && request()->get('ca') != 'pf') ? 'active' : ''}}" id="custom-tabs-two-home-tab" data-toggle="pill" href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home" aria-selected="{{(request()->get('ca') == 'pf' || empty(request()->get('ca')) && request()->get('ca') != 'pf') ? true : false}}">Pessoa Fisica <i class="fas fa-user-alt"></i></a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{request()->get('ca') == 'pj' && request()->get('ca') != 'pf'  ? 'active' : ''}}" id="custom-tabs-two-profile-tab" data-toggle="pill" href="#custom-tabs-two-profile" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="{{request()->get('ca') == 'pj' && request()->get('ca') != 'pf'  ? true : false}}">Pessoa Juridica <i class="fas fa-balance-scale"></i></a>
            </li>
    ...
    <div class="card-body">
        <div class="tab-content" id="custom-tabs-two-tabContent">
            <div class="tab-pane fade {{(request()->get('ca') == 'pf' || empty(request()->get('ca')) && request()->get('ca') != 'pf') ? 'show active' : ''}}" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
            ...
            <div class="tab-pane fade {{request()->get('ca') == 'pj' && request()->get('ca') != 'pf'  ? 'show active' : ''}}" id="custom-tabs-two-profile" role="tabpanel" aria-labelledby="custom-tabs-two-profile-tab">
                <form action="">
                    <div class="form-row mt-3">
                    ...
                    <button type="submit" class="btn btn-block btn-primary">Realizar Contrato</button>
                </form>
            </div>
