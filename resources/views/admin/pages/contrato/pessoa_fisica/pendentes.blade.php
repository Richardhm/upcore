...
<section class="d-flex justify-content-between" style="flex-wrap: wrap;">
        ...
        <!--COLUNA LEFT-->
        <div class="d-flex flex-column text-white ml-1" style="flex-basis:13%;border-radius:5px;">
            ...
            <div style="margin:0;padding:0;background-color:rgba(0,0,0,0.5);border-radius:5px;">
                <h5 class="text-center d-flex align-items-center justify-content-center py-2 border-bottom">Finalizados</h5>
                <ul style="margin:0;padding:0;list-style:none;" id="listar">
        ...
        <!--COLUNA CENTRO-->
        <div class="text-white p-1" style="flex-basis:53%;background-color:rgba(0,0,0,0.5);border-radius:5px;">
        ...
        <div class="mr-1 coluna-right">
           ...
           <section class="p-1">
                ...
                <div class="d-flex mb-2">
                    ...
                    <div style="flex-basis:25%;margin:0 2%;">
    ...
    <script>
        $(function(){   
            ...
            $("#aguardando_boleto_coletivo").on('click',function(){
                ...
                ta.ajax.url("{{ route('contratos.pf.aguadandoBoletoColetivo') }}").load();
                $("#cliente").val('');
                $("#cidade").val('');
                $("#telefone").val('');
                $("#email").val('');
            ...
            $("#aguardando_pagamento_adesao_coletivo").on('click',function(){
                ta.ajax.url("{{ route('contratos.pf.aguardandoPagamentoAdesaoColetivo') }}").load();
                $("#cliente").val('');
                $("#cidade").val('');
                $("#telefone").val('');
                $("#email").val('');
                ...
                // $("#odonto_radio_sim").prop('checked',false);
                // $("#odonto_radio_nao").prop('checked',false);
                // $("#coparticipacao_radio_sim").prop('checked',false);
                // $("#coparticipacao_radio_nao").prop('checked',false);
            ...
            $("#aguardando_pagamento_plano_individual").on('click',function(){
                ta.ajax.url("{{ route('contratos.pf.aguadandoPagamentoPlanoIndividual') }}").load();
                $("#cliente").val('');
                $("#cidade").val('');
                $("#telefone").val('');
                $("#email").val('');
            ...
            $("#aguardando_pagamento_vigencia").on('click',function(){
                ta.ajax.url("{{ route('contratos.pf.aguadandoPagamentoVigencia') }}").load();
                $("#cliente").val('');
                $("#cidade").val('');
                $("#telefone").val('');
                $("#email").val('');
            ...
            $("#aguardando_pagamento_empresarial").on('click',function(){
                ta.ajax.url("{{ route('contratos.pf.aguadandoPagamentoEmpresarial') }}").load();
                $("#cliente").val('');
                $("#cidade").val('');
                $("#telefone").val('');
                $("#email").val('');
            ...
            $("#comissoes").on('click',function(){
                ta.ajax.url("{{ route('contratos.pf.listarComissoes') }}").load();
                $("#cliente").val('');
                $("#cidade").val('');
                $("#telefone").val('');
                $("#email").val('');
            ...
            $("#finalizado").on('click',function(){
                ta.ajax.url("{{ route('contratos.pf.listarFinalizado') }}").load();
                $("#cliente").val('');
                $("#cidade").val('');
                $("#telefone").val('');
                $("#email").val('');
