  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse" collapsing="100000"  aria-labelledby="headingOne" data-parent="#accordionExample">
      ...
      <form action="" method="post" class="px-3">
                @csrf 
                <input type="hidden" name="operadora_selecionada" id="operadora_selecionada" value="">
                
                <h4 style="color:brown;"> - Dados</h4>
                <hr />    
                <div class="errorpessoa"></div>             
                <input type="checkbox" name="pessoa_fisica">Pessoa Fisica
                <input type="checkbox" name="pessoa_juridica">Pessoa Juridica
                ...
                <div class="form-row mt-3">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="celular" id="celular" class="form-control" placeholder="(DD) X XXXXX-XXXX">
...
@section('js')
    ...
    <script>
        $(function(){
            ...
            $('input[name="pessoa_juridica"]').on('change',function(){
            ...
            $('body').on('click','input[name="verPlanos"]',function(e){
                ...
                let pessoa_fisica = $('input[name="pessoa_fisica"]').is(':checked');
                let pessoa_juridica = $('input[name="pessoa_juridica"]').is(':checked');
                ...
                $.ajax({
                    ...
                    beforeSend:function() {
                        ...
                        if(pessoa_fisica == false && pessoa_juridica == false) {
                            $(".errorpessoa").html("<p class='alert alert-danger'>PF ou PJ uma das duas devem ser preenchidas</p>");
                            $('#collapseOne').collapse('show');
                        }
                        if(pessoa_fisica == true && pessoa_juridica == true) {
                            $(".errorpessoa").html("<p class='alert alert-danger'>Escolha PF ou PJ apenas uma das duas deve ser preenchida</p>");
                            $('#collapseOne').collapse('show');
                        }
