...
@section('content')
    ...
    <form action="{{route('vendas.operadora.store')}}" method="POST">
        ...
        <div class="form-group">
            <label for="administradora_id">Administradoras:</label>
            <select name="administradora_id" id="administradora_id" class="form-control form-control-lg">
